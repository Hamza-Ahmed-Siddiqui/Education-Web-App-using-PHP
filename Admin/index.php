                        ...
                        <div class="container-fluid px-4">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body">New Students <span>
                                    <?php
                                        $query = "SELECT COUNT(*) AS `count` FROM `newstudent`";
                                          $result = mysqli_query($conn,$query);
                                          $row = mysqli_fetch_assoc($result);
                                         echo $count = $row['count'];
                                        ?>
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="newStudent.php">View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body">Courses<span>
                                    <?php
                                        $query = "SELECT COUNT(*) AS `count` FROM `course`";
                                          $result = mysqli_query($conn,$query);
                                          $row = mysqli_fetch_assoc($result);
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">Testimonials   <span>
                                    <?php
